  ...
  return (
    <>
      ...
      <main>
        ...
        {/* CONTACTS */}
        <section id="contacts" className="mt-50 w-full grid grid-cols-10 gap-5 justify-between text-white pt-20 pb-20 relative">
          <div className="contacts-bg-full w-full h-[256px]"></div>
          <div className="col-span-5 text-left pl-10">
          ...
          <div className="col-span-5 text-right pr-10">
            ...
            <p className="text-[20px] font-regular text-light-gray text-right">luca.mormile [@] gmail.com</p>
