...
import home from '../../public/images/dailycoach/home.png'
import nutrition from '../../public/images/dailycoach/nutrition.png'
import workout from '../../public/images/dailycoach/workout.png'
import check from '../../public/images/dailycoach/check.png'
import dev from '../../public/images/dailycoach/dev_area.png'
        ...
        <main>
            <section className="mt-20">
                ...
                <div className="mt-50 grid grid-cols-1  gap-10 text-left">
                    ...
                    <h2 className="text-[40px] font-medium text-center">Set a target and go</h2>
                    <div className="grid grid-cols-1 md:grid-cols-4 md:gap-10">
                        <div className="md:col-span-1"></div>
                        <p className='col-span-2 text-[20px] font-light'>The nutrition section is built to give users a clear and structured overview of their daily meal plan.
                ...
                <div className="mt-50 grid grid-cols-1  gap-10 text-left">
                    ...
                    <h2 className="text-[40px] font-medium text-center">Simple data and smooth user experience</h2>
                    <div className="grid grid-cols-1 md:grid-cols-4 md:gap-10">
                        <div className="md:col-span-1"></div>
                        <p className='col-span-2 text-[20px] font-light'>The check section is focused on helping users monitor their physical condition over time through periodic health updates.
                ...
                <div className="mt-50 grid grid-cols-1  gap-10 text-left">
                    ...
                    <h2 className="text-[40px] font-medium text-center">Development</h2>
                    <p className="mb-20 text-[20px] font-light">
