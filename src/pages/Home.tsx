            ...
            <section id="expertises" className="w-full grid grid-cols-1 lg:grid-cols-10 gap-5">
                ...
                <article className="md:col-span-3 text-white">
                    <div className="expertise-box dark-grey">
                        ...
                        <p className="text-[20px] font-light text-left">I design intuitive, user-centered experiences that balance business goals and user needs. With a solid background in usability, interaction flows, and research-driven design,
                    ...
                    <div className="expertise-box dark-grey mt-5">
                        ...
                        <p className="text-[20px] font-light text-left">I craft clean, modern interfaces that combine clarity, consistency, and visual appeal.
                ...
                <article className="md:col-span-3 text-white">
                    <div className="expertise-box dark-grey">
                        ...
                        <p className="text-[20px] font-light text-left">I contribute to shaping digital products from concept to delivery. By combining UX strategy, interface design, and technical feasibility,
                    ...
                    <div className="expertise-box dark-grey mt-5">
                        ...
                        <p className="text-[20px] font-light text-left">With a developer's mindset and years of hands-on coding experience, I bridge the gap between design and implementation.
