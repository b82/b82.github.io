        ...
        <main>
            ...
            <section className="mt-20 grid grid-cols-1 md:grid-cols-2 gap-8">
                <article className="md:col-span-1 text-left">
                    ...
                    <p className="text-[24px] font-regular">Dashboard concept for personal trainers</p>
                    <span className="text-[20px] font-light">Web</span>
                    <p className="mt-5 text-[20px] font-light text-black">
                ...
                <article className="md:col-span-1 text-left">
                    ...
                    <p className="text-[24px] font-regular">App concept for on-site restaurant use</p>
