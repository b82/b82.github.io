...
function Contacts() {
    return (
        <section id="contacts" className="w-full grid grid-cols-1 md:grid-cols-10 gap-5 justify-between text-white pt-10 pb-10 relative">
            <div className="contacts-bg-full w-full h-[286px] md:h-[176px]"></div>
            <div className="md:col-span-5 text-center md:text-left">
                ...
                <p className="text-[20px] font-regular text-light-gray">2025</p>
            </div>
            <div className="md:col-span-5 text-center md:text-right">
                <p className="text-[20px] font-regular">CONTACTS</p>
                <p className="text-[20px] font-regular text-light-gray">mormileluca [@] gmail [.] com</p>
